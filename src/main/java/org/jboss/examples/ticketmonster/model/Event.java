...
/**
 * <p>
 * Represents an event, which may have multiple performances with different
 * dates and venues.
 * </p>
 * 
 * <p>
 * Event's principal members are it's relationship to {@link EventCategory} -
 * specifying the type of event it is - and {@link MediaItem} - providing the
 * ability to add media (such as a picture) to the event for display. It also
 * contains meta-data about the event, such as it's name and a description.
 * </p>
 * 
 * @author Shane Bryzak
...
public class Event implements Serializable {
	...
	/*
	 * toString(), equals() and hashCode() for Event, using the natural identity
	 * of the object
	 */
